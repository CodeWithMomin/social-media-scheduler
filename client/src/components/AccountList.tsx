    ...
    if(accounts.length === 0){
        return (
            ...
            flex flex-col items-center justify-center py-20 px-6">
                ...
                <p className="text-sm text-slate-400 mt-1 max-w-xs text-center"> Connect
                    your first social platform to start scheduling and automating your content
                </p>
            </div>
        )
    }
        ...
        {accounts.map((account,index)=>{
            ...
            return (
                ...
                transition-all">
                    ...
                    title="Disconnect account" className="ml-2 p-1.5 rounded-lg text-slate-300
