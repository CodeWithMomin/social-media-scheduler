            ...
            <div className="p-6 flex flex-col gap-2">
                {PLATFORMS.map((p)=>{
                    ...
                    return (
                        ...
                        className={`fles items-center gap-3 p-3.5 rounded-xl border
                        text-left transition-all ${isConnected ? "border-red-200 bg-red-50 cursor-default":
                            ...
                            <div className="flex-1 min-w-0">
                                <div className={`text-sm ${isConnected ? "text-red-600":
                                    "text-slate-500"
                                }`}>
                                    {p.name}
                                </div>
                            ...
                            {!isConnected && !isConnecting && <ExternalLinkIcon className="size-3.5 text-slate-400"/>}
                        </button>
                    )
                })}
            </div>
