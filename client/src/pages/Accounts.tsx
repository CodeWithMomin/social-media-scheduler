    ...
    <div className='space-y-8 max-w-4xl'>
      ...
      justify-between gap-4 text-sm'>
        <div>
         ...
         <button onClick={()=>setShowPlatformPicker(true)} className='flex items-center gap-2 px-5 py-2.5 bg-red-500 
         hover:bg-red-600 text-white rounded-full font-medium transition-all w-full
